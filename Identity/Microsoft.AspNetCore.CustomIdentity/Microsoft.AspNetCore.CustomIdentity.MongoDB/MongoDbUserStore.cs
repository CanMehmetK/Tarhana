...
namespace Blueshift.Identity.MongoDB
{
        ...
        ObjectId>
    {
        ...
        public MongoDbUserStore(IdentityMongoDbContext context, AppTenant tenant, IdentityErrorDescriber describer = null)
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <param name="context">The context used to access the store.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber" /> used to describe store errors.</param>
        public MongoDbUserStore(IdentityMongoDbContext<TKey> context, AppTenant tenant, IdentityErrorDescriber describer = null)
            : base(context, describer)
        {
        }
    }
        ...
        where TUserToken : MongoDbIdentityUserToken, new()
    {
        ...
        public IQueryable<TUser> TenantUsers => throw new NotImplementedException();
