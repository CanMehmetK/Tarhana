...
namespace Microsoft.AspNetCore.CustomIdentity.EntityFrameworkCore
{
    /// <summary>
    ...
    public class UserStore : UserStore<IdentityUser<string>>
    {
        ...
        public UserStore(DbContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(context, tenant, describer) { }
    }
        ...
        where TContext : DbContext
    {
        ...
        /// <param name="tenant"></param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public UserStore(TContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(context, tenant, describer) { }
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        public UserStore(TContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(describer ?? new IdentityErrorDescriber())
        {
            if (context == null)
            {
        ...
        /// <summary>
        /// Finds and returns a current Tenant user, if any, who has the specified normalized user name.
        /// </summary>
        ...
        public override Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            ThrowIfDisposed();
            // TODO:@kanpinar        
            var users = Users.Where(t => t.NormalizedUserName == normalizedUserName);
            var user = Users.FirstOrDefaultAsync(u => u.NormalizedUserName == normalizedUserName, cancellationToken);
            
            if (user != null)
            {
                var userRole = IsInRoleAsync(user as TUser, "MASTER", cancellationToken); 
                if (userRole != null)
                    return user;
            }
            
            return Users.FirstOrDefaultAsync(u => u.NormalizedUserName == normalizedUserName && u.TenantId == Tenant.Id, cancellationToken);
        }

        /// <summary>
        /// Finds and returns a specified Tenant user, if any, who has the specified normalized user name.
        /// </summary>
        /// <param name="normalizedUserName">The normalized user name to search for.</param>
        ...
        /// The <see cref="Task"/> that represents the asynchronous operation, containing the user matching the specified <paramref name="normalizedUserName"/> if it exists.
        /// </returns>
        public Task<TUser> FindByNameAsync(string normalizedUserName, Guid tenantId, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
        ...
        public override IQueryable<TUser> Users
        {
            get
            {
                ...
                //    return UsersSet;
                //else
                    return UsersSet;//.Where(t => t.TenantId == Tenant.Id);
                //return UsersSet;
            }
        }
        ...
        /// A navigation property for the users the store contains.
        /// </summary>
        public override IQueryable<TUser> TenantUsers
        {
            get
            {
                return UsersSet.Where(t => t.TenantId == Tenant.Id);             
        ...
        public override Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Users.FirstOrDefaultAsync(u => u.NormalizedEmail == normalizedEmail && u.TenantId == Tenant.Id, cancellationToken);
        }
        ...
        public async override Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var query = from userclaims in UserClaims
                        ...
                        && userclaims.ClaimType == claim.Type && user.TenantId == Tenant.Id
                        select user;
        ...
        public async override Task<IList<TUser>> GetUsersInRoleAsync(string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (role != null)
            {
                var query = from userrole in UserRoles
                            ...
                            where userrole.RoleId.Equals(role.Id) && user.TenantId == Tenant.Id
                            select user;
