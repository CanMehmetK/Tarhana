...
namespace Microsoft.AspNetCore.CustomIdentity.EntityFrameworkCore
{
    ...
    public class UserOnlyStore<TUser>
        : UserOnlyStore<TUser, DbContext, string>
        where TUser : IdentityUser<string>, new()
    {
        ...
        public UserOnlyStore(DbContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(context, tenant, describer) { }
    }
        ...
        where TContext : DbContext
    {
        ...
        /// <param name="tenant"></param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public UserOnlyStore(TContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(context, tenant, describer) { }
    }
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// </summary>
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="tenant"><see cref="AppTenant"/></param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public UserOnlyStore(TContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(context, tenant, describer) { }
    }
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        public UserOnlyStore(TContext context, AppTenant tenant, IdentityErrorDescriber describer = null) : base(describer ?? new IdentityErrorDescriber())
        {
            if (context == null)
            {
        ...
        {
            // TODO:Z  : TenantId update is a Problem Or Not
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            if (user == null)
            {
        ...
        {
            // TODO:Z Deleting MASTER Role user is a Problem Or Not
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            if (user == null)
            {
        ...
        /// A navigation property for the users the store contains.
        /// </summary>
        public override IQueryable<TUser> TenantUsers => UsersSet.Where(t => t.TenantId == Tenant.Id);
