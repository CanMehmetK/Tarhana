...
namespace Microsoft.AspNetCore.CustomIdentity
{
    ...
    public class SignInManager<TUser> where TUser : class
    {
        ...
        public virtual async Task RefreshSignInAsync(TUser user)
        {
            ...
            var authenticationMethod = auth?.Principal?.CustomFindFirstValue(ClaimTypes.AuthenticationMethod);
        ...
        public virtual async Task<TUser> ValidateSecurityStampAsync(ClaimsPrincipal principal)
        {
            ...
            if (await ValidateSecurityStampAsync(user, principal.CustomFindFirstValue(Options.ClaimsIdentity.SecurityStampClaimType)))
            {
                return user;
            }
            return null;
        ...
        public virtual async Task<bool> IsTwoFactorClientRememberedAsync(TUser user)
        {
            ...
            return (result?.Principal != null && result.Principal.CustomFindFirstValue(ClaimTypes.Name) == userId);
        }
        ...
        public virtual async Task<ExternalLoginInfo> GetExternalLoginInfoAsync(string expectedXsrf = null)
        {
            ...
            var providerKey = auth.Principal.CustomFindFirstValue(ClaimTypes.NameIdentifier);
        ...
        private async Task<TwoFactorAuthenticationInfo> RetrieveTwoFactorInfoAsync()
        {
            ...
            if (result?.Principal != null)
            {
                ...
                {
                    UserId = result.Principal.CustomFindFirstValue(ClaimTypes.Name),
                    LoginProvider = result.Principal.CustomFindFirstValue(ClaimTypes.AuthenticationMethod)
                };
            }
            return null;
        }
