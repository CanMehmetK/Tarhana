...
using Microsoft.Extensions.CustomIdentity.Core;
...
namespace Microsoft.AspNetCore.CustomIdentity
{
    ...
    public class UserManager<TUser> : IDisposable where TUser : class
    {
        ...
        private AppTenant Tenant { get; set; }
        ...
        ///     Returns an IQueryable of users if the store is an IQueryableUserStore
        /// </summary>
        public virtual IQueryable<TUser> TenantUsers
        {
            get
            {
                var queryableStore = Store as IQueryableUserStore<TUser>;
                ...
                return queryableStore.TenantUsers;
            }
        }
        ...
        public virtual string GetUserName(ClaimsPrincipal principal)
        {
            ...
            return principal.CustomFindFirstValue(Options.ClaimsIdentity.UserNameClaimType);
        }
        ...
        public virtual string GetUserId(ClaimsPrincipal principal)
        {
            ...
            return principal.CustomFindFirstValue(Options.ClaimsIdentity.UserIdClaimType);
        }
