...
namespace Microsoft.AspNetCore.CustomIdentity
{
    ...
    public interface IQueryableUserStore<TUser> : IUserStore<TUser> where TUser : class
    {
        ...
        /// <summary>
        /// Returns an <see cref="IQueryable{T}"/> collection of Tenant users.
        /// </summary>
        /// <value>An <see cref="IQueryable{T}"/> collection of Tenant users.</value>
        IQueryable<TUser> TenantUsers { get; }
    }
}